...
struct allPosts {
    ...
    """, image: "scientistСat", likes: 64, views: 128),
        ...
        PostVK(liked: false, author: "Gavryusha the Cat", description: "Нарисовал шедевр. Масло плохо оттирается от лапок. В следующий раз буду использовать только акрил.", image: "myPainting", likes: 16, views: 32),
        PostVK(liked: false, author: "Gavryusha the Cat", description: """
