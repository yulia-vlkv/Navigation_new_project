...
struct allPosts {
     static var postArray = [
        PostVK(liked: false, author: "Gavryusha the Cat", description: """
    ...
    """, image: "scientistСat", likes: 64, views: 128),
        PostVK(liked: false, author: "Gavryusha the Cat", description: "Играл в монополию. Скучно, я всегда выигрываю.", image: "playingMonopoly", likes: 32, views: 64),
        PostVK(liked: false, author: "Cat", description: "Нарисовал шедевр. Масло плохо оттирается от лапок. В следующий раз буду использовать только акрил.", image: "myPainting", likes: 16, views: 32),
        PostVK(liked: false, author: "Gavryusha", description: """
