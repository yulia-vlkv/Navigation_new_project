...
struct allPosts {
    ...
    """, image: "scientistСat", likes: 64, views: 128),
        ...
        PostVK(author: "Cat", description: "Нарисовал шедевр. Масло плохо оттирается от лапок. В следующий раз буду использовать только акрил.", image: "myPainting", likes: 16, views: 32),
        PostVK(author: "Gavryusha", description: """
